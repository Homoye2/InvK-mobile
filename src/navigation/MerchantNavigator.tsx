...
import SalesScreen from '../screens/merchant/SalesScreen';
import InventoryScreen from '../screens/merchant/InventoryScreen';
import TeamScreen from '../screens/merchant/TeamScreen';
  ...
  return (
    ...
    >
      ...
      <Tab.Screen
        ...
        options={{ title: 'Produits', tabBarIcon: ({ color, size }) => <Ionicons name="cube-outline" size={size} color={color} /> }}
      />
      <Tab.Screen
        name="Sales"
        component={SalesScreen}
        options={{ title: 'Ventes', tabBarIcon: ({ color, size }) => <Ionicons name="cash-outline" size={size} color={color} /> }}
      />
      <Tab.Screen
        name="Inventory"
        component={InventoryScreen}
        options={{ title: 'Stocks', tabBarIcon: ({ color, size }) => <Ionicons name="layers-outline" size={size} color={color} /> }}
      />
      <Tab.Screen
        name="Team"
        component={TeamScreen}
        options={{ title: 'Équipe', tabBarIcon: ({ color, size }) => <Ionicons name="people-outline" size={size} color={color} /> }}
      />
    </Tab.Navigator>
  );
}
